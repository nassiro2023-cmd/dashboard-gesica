...
# =============================================================================
# PAGE D'ACCUEIL / PRÉSENTATION (sans onglets)
# =============================================================================

st.markdown("---")
st.markdown("##  Bienvenue sur le Dashboard Gesica")
st.markdown("""
**Objectif** : Estimer le taux réel d'infectés à partir des passages aux urgences en Franche-Comté.

**Problème** : Les passages observés H(t) ne représentent qu'une fraction des vrais infectés I(t).

**Solution** : Un modèle SIRS calibré sur les données 2020-2025.
...
# RÉSULTATS CLÉS
# =============================================================================
st.markdown("##  Résultats clés du modèle")

col1, col2, col3, col4 = st.columns(4)

with col1:
    st.metric("α (taux de couplage)", "0.45", "55% de renoncement")
    st.caption("H(t) = 0,45 × I(t)")

with col2:
    st.metric("Pic I(t)", "71 350 / 100k", "71% de la population")

with col3:
    st.metric("R² test", "0.70", "70% de variance expliquée")

with col4:
    st.metric("Hiver vs été", "51× plus risqué", "Saisonnalité")
...
# MÉTHODOLOGIE
# =============================================================================
st.markdown("##  Méthodologie en 3 étapes")
...
# =============================================================================
st.markdown("##  Utilité opérationnelle")

st.markdown("""
| Question | Réponse du modèle |
|----------|-------------------|
| Combien de lits prévoir ? | **VaR 95%** → 16 000 lits |
| Quel est le risque actuel ? | **Seuils d'alerte** → Vert (situation calme) |
| Et si un variant arrive ? | **Stress test** → x5 → 9,4% de risque |
| L'hiver est-il plus risqué ? | **51× plus risqué** que l'été |
| Que faire en priorité ? | **Mesures barrières** → -51% de risque |
""")
...
# =============================================================================
st.markdown("""
** Utilisez les onglets ci-dessus pour explorer :**
-  I(t) & Modèle : voir l'estimation du taux d'infectés
-  Distribution : comprendre la loi Log-Normale
-  VaR & Monte Carlo : dimensionner les ressources
-  Stress Test : simuler des scénarios de crise
- Seuils d'alerte : piloter la situation
-  What if : tester l'impact des décisions
""")
